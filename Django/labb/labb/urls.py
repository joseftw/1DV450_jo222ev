...
urlpatterns = patterns('',
    ...
    url(r'^projects/(?P<project_id>\d+)/tickets/delete/$', 'labb1.views.project_delete_ticket', name="project_delete_ticket"),
    url(r'^projects/(?P<project_id>\d+)/tickets/edit/$', 'labb1.views.project_edit_ticket', name="project_edit_ticket"),
